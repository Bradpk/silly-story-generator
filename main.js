...
function result() {
  ...
  if(document.getElementById("uk").checked) {
    ...
    const temperature =  Math.round(94 - 32 / 1.8) + 'celcius';
    const newStory = newStory.replace('300 pounds', weight);
    const newStory - newStory.replace('94 fahrenheit', temperature);
